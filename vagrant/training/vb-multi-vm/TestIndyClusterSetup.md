...
```sh
$ git clone https://github.com/panickervinod/indy-environments.git
$ cd indy-environments/vagrant/training/vb-multi-vm
$ git checkout stable
```

At this point, you have all the artifacts necessary to create a Indy cluster
...
First, you will use it in the role of a Indy Steward, a privileged user who
